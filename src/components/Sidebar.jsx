...
import logo from "../assets/lapiz-mejor-tin.png";
...
const Letter = styled.span`
  ...
  ${({ index }) => {
    switch (index) {
      ...
      case 2:
        return 'transform: rotate(-4deg);';
      case 3:
        return 'transform: rotate(-2deg);';
      case 4:
        return 'transform: rotate(-2deg);';
      case 5:
        return 'transform: rotate(-2deg);'; // Añadido un caso para la segunda 'i'
      default:
